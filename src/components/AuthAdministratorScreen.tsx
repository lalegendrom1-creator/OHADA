    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md animate-scale-in">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-amber-500 text-slate-900 mb-4 shadow-lg shadow-amber-500/30">
            <ShieldCheck size={36} strokeWidth={2.2} />
          </div>
          <div className="inline-block px-3 py-1 mb-2 rounded-full bg-amber-500/10 border border-amber-500/20 text-amber-400 text-xs font-semibold uppercase tracking-wider">
            Accès Réservé
          </div>
